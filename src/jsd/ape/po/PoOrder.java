...
/**
 * @author 作者  张瑞坤
 * @version 创建时间：2019-5-6 下午5:16:03
 *  艾派    采购订单
 */
public class PoOrder {
	public String triggerProcess4(String jsonstr,String flag){
...
//		JSONObject jsn = null;
		...
		String result = "";
		String workflowid = "188";//流程id------------------158
...
//							JSONObject jsn1 = null;
//							try {
//								jsn1 = new JSONObject("{\"return_type\":\"E\",\"return_message\":\""+head.getString("FCreatorDeptID")+"部门不存在OA中\",\"requestid\":\"0\"}");
//							}catch (JSONException e) {
//								e.printStackTrace();
//								log.writeLog("异常2----"+e.getMessage());
//							}
...
//					if(PurOper.length()>0){
//						String str = "select id,departmentid,subcompanyid1,workcode from hrmresource where workcode = '"+PurOper+"'" ;
//						rs.executeSql(str);
//						if(rs.next()){
...
//				}
				...
				if(!head.isNull("TotalAmountNTaxed")){
					String TotalAmountNTaxed = head.getString("TotalAmountNTaxed");;
					head.put("TotalAmountNTaxed", gu.getFour(TotalAmountNTaxed));	
					jsar.getJSONObject(i).put("HEADER", head);
				}
				//
//				if(!head.isNull("Enclosure")){
//					StringBuffer stb = new StringBuffer();
//					String Fnames = head.getString("Enclosure");
