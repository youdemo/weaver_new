...
<%@ page import="morningcore.sap.IV_Flag_AccountBapi" %>
...
<FORM id=report name=report method=post> <!--/task/point/sysnDevelopPerPoint.jsp-->
    ...
    <wea:layout type="2col">
        <wea:group context="科目同步" attributes="test">
            <wea:item>科目同步</wea:item>
            <wea:item>
                <input name="hi2" type="button" value="科目同步" class="e8_btn_top_first"
