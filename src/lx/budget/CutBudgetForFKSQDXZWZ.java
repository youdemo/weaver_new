...
/**
 * 付款申请单（行政物资、IT物资、外修） 扣减预算
 * @author tangj
 *
 */
public class CutBudgetForFKSQDXZWZ implements Action{
	...
	public void UpdateMid (String cbzxbm,String xmbm,String kmbm,String sqyf,String bcsqje) {
		...
		if(!"".equals(billid)) {
			sql= "update uf_apl_budget_mid set djje=djje-"+bcsqje+",yyje=yyje+"+bcsqje+" where id="+billid;
			rs.executeSql(sql);				
		}
	}
}
