 ...
 * 
 */
public class PurchaseAppWebserviceActionYBWL implements Action {

	BaseBean log = new BaseBean();

	public String execute(RequestInfo info) {
		log.writeLog("Start PurchaseAppWebserviceActionYBWL——————");
		...
		while (rs.next()) {
			...
			String APPNAME = Util.null2String(rs.getString("sqmxm"));// 申请人姓名
