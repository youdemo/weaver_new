 ...
 *
 */
public class PRBudgetApplyActionGDZC implements Action {
	...
	public String execute(RequestInfo info) {
		...
		log.writeLog("PRBudgetApplyActionGDZC------");
		...
		while (rs.next()) {
			...
			String fycd = Util.null2String(rs.getString("fycdbm"));
			...
			log.writeLog("PRBudgetApplyActionGDZC sql:"+sql_dt);
			String prid="";
