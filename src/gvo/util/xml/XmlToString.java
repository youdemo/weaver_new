...
public class XmlToString {
    ...
    public static void main(String[] args) {
        String para = "<sap:SIGN>S</sap:SIGN><sap:Message><![CDATA[<DATA><HEAD/><LIST><ITEM><OA_ID>4814</OA_ID><MSG_CONTENT>流程创建成功</MSG_CONTENT></ITEM></LIST></DATA>]]></sap:Message>\n";
        String para2 = "{message=<DATA><HEAD><HEAD><BIZTRANSACTIONID>?</BIZTRANSACTIONID><RESULT>0</RESULT><ERRORCODE/><ERRORINFO/><COMMENTS/><SUCCESSCOUNT>2</SUCCESSCOUNT></HEAD></HEAD><LIST><ITEM><E_BANFN>3500004931</E_BANFN><E_MSGTX></E_MSGTX/></ITEM></LIST></DATA>, sign=S}";
        ...
        String msg = xts.getTotalMidValue(para, "<MSG_CONTENT>", "</MSG_CONTENT>");
