...
public class EMReimAction extends BaseBean implements Action {
    BaseBean log = new BaseBean();
    public String execute(RequestInfo info) {
        log.writeLog("进入员工费用报销流程EMReimAction————————");
...
//            log.writeLog("查看json格式————————" + json);
            ...
            try {
                result = ems.getResultMethod(json);
            } catch (Exception e) {
...
//            log.writeLog("返回结果message————————" + message);
            ...
            Map<String, Object> re = saxXmlUtil.getXmlMap(message);
            Object SAPRETURNNO = re.get(para);//SAP回写凭证号
            Object SAPRETURNEMSG = re.get(para1);//SAP回写错误消息
