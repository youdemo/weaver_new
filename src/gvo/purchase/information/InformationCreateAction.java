...
public class InformationCreateAction extends BaseBean implements Action{
	/**
	 * oa与sap采购信息记录创建
	 * 
	 * @author daisy
	...
	public String execute(RequestInfo info) {
		log.writeLog("进入采购信息记录创建 InformationCreateAction——————");
		...
		if(!"".equals(tableName)){
			...
			for(Item item:itemList){
	        	...
	        	String sql_update = "update " + tableNamedt1 + " set recordno='" + recordno
				+ "',sapmessage = '" + sapmessage + "',sapstatus = '" + status + "',oaid = '" + oaid + "' where mainid = " + mainID + " and oaid = " + oaid;
