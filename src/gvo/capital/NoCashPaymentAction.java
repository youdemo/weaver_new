...
/**
 * 非现金报销付款申请霸州 V2-021与资金系统对接回写
 * 
 * @author daisy
 * @version 3.0  2017-10-31
 * 
 **/
public class NoCashPaymentAction implements Action {
    BaseBean log = new BaseBean();

    public String execute(RequestInfo info) {
        log.writeLog("进入非现金报销付款申请霸州 V2-021 NoCashPaymentAction——————");
