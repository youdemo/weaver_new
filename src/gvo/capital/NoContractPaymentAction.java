 ...
 * 
 **/
public class NoContractPaymentAction implements Action {
    BaseBean log = new BaseBean();

    public String execute(RequestInfo info) {
        log.writeLog("进入对公无合同预付款 NoContractPaymentAction——————");
        ...
        if (!"".equals(tableName)) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    String ZZBS = Util.null2String(rs.getString("yflx"));;//预付类型
