...
public class editProcessCommonField implements Action{
	...
	public String execute(RequestInfo info) {
		...
		sql="select * from uf_prj_porcessfield where fieldname='"+fieldname+"' and iscommon='0'";
		rs.executeSql(sql);
		while(rs.next()){
			...
			iu.updateGen(mapStr, "uf_prj_porcessfield", "id", fieldid);
		}
		return SUCCESS;
	}
}
