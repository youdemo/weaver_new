 ...
 *
 */
public class DoHXImpl {
	BaseBean log = new BaseBean();
	public Map<String, String> doHX(String tableName,String requestId,String bookid,String pch,String now,String SEGMENT1) {
		...
		String sql = "select id,(select lastname from hrmresource where id=hxr) as hxr,sqrq,bb,dfkm,hl,hxsm from "+tableName+" where requestId="+requestId;
		...
		while(rs.next()){
			...
			hxlx2 = Util.null2String(rs.getString("hxlx2"));
			...
			//mapStr.put("REFERENCE1", fbbm_dt1);
				...
				mapStr.put("REFERENCE2", hxr+" "+hxsm);
				mapStr.put("REFERENCE5", hxr+" "+hxsm);
				mapStr.put("REFERENCE10", hxr+" "+hxsm);
				mapStr.put("REFERENCE30", ccf.interfaceseq+"");
				 ccf.interfaceseq= ccf.interfaceseq+10;
				iu.insertzj(mapStr, "ZJ_GL_INTERFACE");
