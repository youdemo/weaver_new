...
public class BringMainAndDetailByMain {
	...
	public static String getFunctionNameByWorkflowID(String id) {
		String result = "";
		String sql = "select distinct SAPFunctionName from uf_TMC_SAP_MAPPING where workflowId ="
				+ id;
	...
	private static String getInputType(String workflowid) {
		...
		String sql = "select SAPParameterType from uf_TMC_SAP_MAPPING where SAPParameterType like 'in%' and workflowid ='"
				+ workflowid+"'" ;
		rs.executeSql(sql);
		if (rs.next()) {
	...
	public static List<SapOaMappingBean> getOutParameters(String workflowId,
		...
		String sql = "select *  from uf_TMC_SAP_MAPPING where workflowid = "
	...
	public static SapOaMappingBean getInputParameter(String workflowId,
		...
		String sql = "select *  from uf_TMC_SAP_MAPPING where OAFieldName ='"
	...
	public static List<String> getOAParaName(String workflowId) {
		...
		String sql = "select OAFieldName from uf_TMC_SAP_MAPPING where workflowId = "
...
//		basebean.writeLog("根据流程获取需要传入到SAP的OA参数名称sql：" + sql);
	...
	public static List<SapOaMappingBean> getRelation(String workflowId) {
		String sql = "select OAFieldName, SAPParameterType,SAPParameterName,SAPFieldName from uf_TMC_SAP_MAPPING where workflowId = "
				+ workflowId;
		sql = "select * from uf_TMC_SAP_MAPPING where workflowId = " + workflowId;
