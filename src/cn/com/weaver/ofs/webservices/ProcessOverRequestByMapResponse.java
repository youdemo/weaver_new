/**
 * ProcessOverRequestByMapResponse.java
 *
...
public class ProcessOverRequestByMapResponse  implements java.io.Serializable {
    private cn.com.weaver.ofs.webservices.AnyType2AnyTypeMapEntry[] out;

    public ProcessOverRequestByMapResponse() {
    }
    ...
    /**
     * Gets the out value for this ProcessOverRequestByMapResponse.
     * 
     * @return out
     */
    ...
    /**
     * Sets the out value for this ProcessOverRequestByMapResponse.
     * 
     * @param out
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ProcessOverRequestByMapResponse)) return false;
        ProcessOverRequestByMapResponse other = (ProcessOverRequestByMapResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProcessOverRequestByMapResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("webservices.ofs.weaver.com.cn", ">processOverRequestByMapResponse"));
