/**
 * ReceiveTodoRequestByMapResponse.java
 *
...
public class ReceiveTodoRequestByMapResponse  implements java.io.Serializable {
    private cn.com.weaver.ofs.webservices.AnyType2AnyTypeMapEntry[] out;

    public ReceiveTodoRequestByMapResponse() {
    }
    ...
    /**
     * Gets the out value for this ReceiveTodoRequestByMapResponse.
     * 
     * @return out
     */
    ...
    /**
     * Sets the out value for this ReceiveTodoRequestByMapResponse.
     * 
     * @param out
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReceiveTodoRequestByMapResponse)) return false;
        ReceiveTodoRequestByMapResponse other = (ReceiveTodoRequestByMapResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReceiveTodoRequestByMapResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("webservices.ofs.weaver.com.cn", ">receiveTodoRequestByMapResponse"));
