/**
 * DeleteRequestInfoByMapResponse.java
 *
...
public class DeleteRequestInfoByMapResponse  implements java.io.Serializable {
    private cn.com.weaver.ofs.webservices.AnyType2AnyTypeMapEntry[] out;

    public DeleteRequestInfoByMapResponse() {
    }
    ...
    /**
     * Gets the out value for this DeleteRequestInfoByMapResponse.
     * 
     * @return out
     */
    ...
    /**
     * Sets the out value for this DeleteRequestInfoByMapResponse.
     * 
     * @param out
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DeleteRequestInfoByMapResponse)) return false;
        DeleteRequestInfoByMapResponse other = (DeleteRequestInfoByMapResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DeleteRequestInfoByMapResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("webservices.ofs.weaver.com.cn", ">deleteRequestInfoByMapResponse"));
