/**
 * ProcessDoneRequestByMapResponse.java
 *
...
public class ProcessDoneRequestByMapResponse  implements java.io.Serializable {
    private cn.com.weaver.ofs.webservices.AnyType2AnyTypeMapEntry[] out;

    public ProcessDoneRequestByMapResponse() {
    }
    ...
    /**
     * Gets the out value for this ProcessDoneRequestByMapResponse.
     * 
     * @return out
     */
    ...
    /**
     * Sets the out value for this ProcessDoneRequestByMapResponse.
     * 
     * @param out
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ProcessDoneRequestByMapResponse)) return false;
        ProcessDoneRequestByMapResponse other = (ProcessDoneRequestByMapResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProcessDoneRequestByMapResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("webservices.ofs.weaver.com.cn", ">processDoneRequestByMapResponse"));
