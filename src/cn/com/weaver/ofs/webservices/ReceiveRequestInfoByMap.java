...
public class ReceiveRequestInfoByMap  implements java.io.Serializable {
    ...
    /**
     * Gets the in0 value for this ReceiveRequestInfoByMap.
     * 
     * @return in0
     */
    ...
    /**
     * Sets the in0 value for this ReceiveRequestInfoByMap.
     * 
     * @param in0
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReceiveRequestInfoByMap)) return false;
        ReceiveRequestInfoByMap other = (ReceiveRequestInfoByMap) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReceiveRequestInfoByMap.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("webservices.ofs.weaver.com.cn", ">receiveRequestInfoByMap"));
