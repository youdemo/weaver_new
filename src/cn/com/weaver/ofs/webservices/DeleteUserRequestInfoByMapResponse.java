/**
 * DeleteUserRequestInfoByMapResponse.java
 *
...
public class DeleteUserRequestInfoByMapResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the out value for this DeleteUserRequestInfoByMapResponse.
     * 
     * @return out
     */
    ...
    /**
     * Sets the out value for this DeleteUserRequestInfoByMapResponse.
     * 
     * @param out
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DeleteUserRequestInfoByMapResponse)) return false;
        DeleteUserRequestInfoByMapResponse other = (DeleteUserRequestInfoByMapResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DeleteUserRequestInfoByMapResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("webservices.ofs.weaver.com.cn", ">deleteUserRequestInfoByMapResponse"));
