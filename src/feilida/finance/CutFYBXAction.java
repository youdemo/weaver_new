...
public class CutFYBXAction implements Action {
	...
	public String execute(RequestInfo info) {
		...
		if("1".equals(EXECTYPE)){
			...
			updateinfo(tableName,requestid,"0",mainId,OADATE,DEPTID,STAFFID,EXECTYPE,COMPID);
		}
	...
	public void updateinfo(String tableName,String requestid,String OPTTYPE,String mainId,String OADATE,String DEPTID,String STAFFID,String EXECTYPE,String COMPID){
		RecordSet rs = new RecordSet();
		String sql="";
		String KOSTL = "";// 成本中心
		String KSTAR = "";// 会计科目
