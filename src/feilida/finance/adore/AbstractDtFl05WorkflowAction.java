 ...
 * 明细行摘要
 * 字段组合出来，月份+付+供应商简称，需要自动出来，不能超过50个字符
 */
public class AbstractDtFl05WorkflowAction implements Action {
    BaseBean log = new BaseBean();

    public String execute(RequestInfo info) {
        log.writeLog("进入FI-05供应商一般付款申请表单（非银企直联）AbstractDtFl05WorkflowAction——————");
        ...
        if (!"".equals(tableName)) {
            ...
            while (rs.next()) {
                ...
                String abstract_dt = applyDate + "付" + lastname;
